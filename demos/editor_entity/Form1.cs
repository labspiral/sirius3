...
namespace Demos
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // RTC I/O
            siriusEditorControl1.DIExt1 = IOFactory.CreateInputExtension1(rtc);
            siriusEditorControl1.DIExt1.Initialize();
            siriusEditorControl1.DOExt1 = IOFactory.CreateOutputExtension1(rtc);
            siriusEditorControl1.DOExt1.Initialize();
            siriusEditorControl1.DOExt2 = IOFactory.CreateOutputExtension2(rtc);
            siriusEditorControl1.DOExt2.Initialize();
            siriusEditorControl1.DILaserPort = IOFactory.CreateInputLaserPort(rtc);
            siriusEditorControl1.DILaserPort.Initialize();
            siriusEditorControl1.DOLaserPort = IOFactory.CreateOutputLaserPort(rtc);
            siriusEditorControl1.DOLaserPort.Initialize();

            // Laser & PowerMeter (virtual)
            double laserMaxPower = 20;
            var powerMeter = PowerMeterFactory.CreateVirtual(0, laserMaxPower);
            var laser = LaserFactory.CreateVirtualDutyCycle(0, laserMaxPower, 0, 100);
            laser.Scanner = rtc;
            laser.Initialize();
            ...
            // Marker
            var rtcMarker = MarkerFactory.CreateRtc(0);
            siriusEditorControl1.Marker = rtcMarker;
        ...
        void CreateEntities()
        {
            points_testcase();
            line_arc_testcase();
            triangle_rectangle_testcase();
            polyline2d_testcase();
            polyline3d_testcase();
            hatch_testcase();
            bezierSpline_testcase();
            catmullRomSpline_testcase();
            text_testcase();
            image_testcase();
            gridcloud_testcase();
            large_lines_testcase();
            barcode_testcase();
            groupIngroup_testcase();
            sphere_testcase();
            cube_cylinder_testcase();
            block_insert_testcase();
            //gerber_testcase();
            zpl_testcase();
        }
        ...
        /// </summary>
        private void line_arc_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
        ...
        /// </summary>
        private void triangle_rectangle_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
        ...
        /// </summary>
        private void cube_cylinder_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
            const int ENTITY_COUNT = 5;
        ...
        /// </summary>
        private void gridcloud_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
            const int COLS = 1024;
            const int ROWS = 768;
        ...
        /// </summary>
        private void polyline2d_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
            const int ENTITY_COUNT = 5;
        ...
        /// </summary>
        private void polyline3d_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
            const int ENTITY_COUNT = 5;
        ...
        /// </summary>
        private void bezierSpline_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
            const int ENTITY_COUNT = 5;
        ...
        /// </summary>
        private void catmullRomSpline_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
            const int ENTITY_COUNT = 5;
        ...
        /// </summary>
        private void groupIngroup_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
        ...
        /// </summary>
        private void block_insert_testcase()
        {
            var rng = new Random((int)DateTime.Now.Ticks);
        ...
        /// </summary>
        private void large_lines_testcase()
        {
            // Pack 1
            {
